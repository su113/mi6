...
namespace lab4t2
{
    class Student
    {
        ...
        public Student(string name,string lastname,int number_of_studentbook, int math,int physic,int computer_sys,int web,int networking)
        {
            this.name=name;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            group[0]=new Student("Andriy","Petro",1,99,100,98,100,100);       
            group[1]=new Student("Nazar","Shpeck",2,89,90,88,90,90);
            group[2]=new Student("Yura","Kshuk",3,79,80,78,80,80);
            group[3]=new Student("Vasul","Kebus",4,69,70,68,70,70);
            group[4]=new Student("Vlad","Kozak",5,89,90,88,90,90);
