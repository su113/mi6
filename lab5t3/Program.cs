...
namespace lab5t3
{
    ...
    class Session:Doctor
    {
        ...
        public virtual string Comentar{get{return comentar;}set{this.comentar=value;}}
        public Session()
        {
            //Constructor
        }        
        ...
        public virtual void Writer(StreamWriter f)
        {
            f.WriteLine(Name);
        ...
        public virtual DayOfWeek Get_SesionDay(string tmp)
        {
    ...
    class DataBase
    {
        ...
        public DayOfWeek Get_SesionDay(string tmp)
        {
            DayOfWeek value=new DayOfWeek();
            if(tmp=="Monday"){value=DayOfWeek.Monday;return value;}
            if(tmp=="Tuesday"){value=DayOfWeek.Tuesday;return value;}
